...
public class Updateinmuebles extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            inmuebles persona = new inmuebles(id_inmueble, tipoinmueble, tipoperacion,num_recamaras, num_banos, num_medbanos, num_garage, jardin, alberca, precio, ubicacion, observaciones);
