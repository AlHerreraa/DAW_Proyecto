...
<main class="main">
    <div class="container">
        <br/><h1>Cliente</h1>
        <p>Futuro comprador o arrendador de algún inmueble que los agentes ofrezcan.</p>
        <br>
        <form class="center" action="/DAW_Inmobiliaria/Cliente JSP/cliente.jsp">
            <input type="submit" class=" opc opc-green" value="Lista de Clientes">
        </form><br>

        <form class="center" action="/DAW_Inmobiliaria/Cliente JSP/Inserta_cliente.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Cliente">
        </form><br>
        <form class="center" action="/DAW_Inmobiliaria/Cliente JSP/Update_cliente.jsp">
