...
<main class="main">
    <div class="container">
        <br/><h1>Rentas</h1>
        <p>Inmuebles para operación de renta en la ciudad indicada.</p>
        <br>
        <form class="center" action="/DAW_Inmobiliaria/Agente/rentas.jsp">
            <input type="submit" class=" opc opc-green" value="Lista Rentas">
        </form><br>
        <form class="center" action="/DAW_Inmobiliaria/Agente/Inserta_renta.jsp">
            <input type="submit" class=" opc opc-green" value="Inserta Renta">
        </form><br>
        <form class="center" action="/DAW_Inmobiliaria/Agente/Update_rentas.jsp">
