...
@WebServlet(name = "Insertaagenteinmo", urlPatterns = {"/Insertaagenteinmo"})
public class Insertaagenteinmo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect("/LibreriaCientifica/Inserta_agente.jsp");
    }
}