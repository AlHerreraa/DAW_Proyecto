...
public class Insertainmuebles extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            inmuebles inmu = new inmuebles(id_inmueble, tipoinmueble, tipoperacion,num_recamaras, num_banos, num_medbanos, num_garage, jardin, alberca, ubicacion, observaciones, precio);
